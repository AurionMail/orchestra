...
module.exports = {
    ...
    archivePath: './storage/archive',
    pinPath: './storage/pins',
    taskPath: './storage/tasks',
    blockPath: './storage/block',
    blobPath: './storage/blob',
    blobStagingPath: './storage/blobstage',
    decreePath: './storage/decrees',
    logPath: './logs',
};
`, persistentConfigPath, c.Domain, c.Domain, c.Domain)
