...
module.exports = {
	...
	logFeedback: false,
	verbose: false,
	installMethod: 'aurion-binary',
};
`,
			persistentConfigPath,
			c.Domain, c.Domain,
			filepath.Join(storageDir, "datastore"),
...
func (c *Config) GetSSOEnv() map[string]string {
	...
	return map[string]string{
		...
		"SESSION_SECRET":                getOrDefault(c.Raw, "SESSION_SECRET", "shhshs89623303214687dyyrierrpreerer8er8er9erre8r2re2er0re0er2er6d8v8vvc6vc6fggf4g5"),
		"EXTERNAL_OIDC_ISSUER":          getOrDefault(c.Raw, "EXTERNAL_OIDC_ISSUER", ""),
		"EXTERNAL_OIDC_CLIENT_ID":       getOrDefault(c.Raw, "EXTERNAL_OIDC_CLIENT_ID", ""),
		"EXTERNAL_OIDC_CLIENT_SECRET":   getOrDefault(c.Raw, "EXTERNAL_OIDC_CLIENT_SECRET", ""),
		"EXTERNAL_OIDC_LOGOUT_URI":      getOrDefault(c.Raw, "EXTERNAL_OIDC_LOGOUT_URI", ""),
		"EXTERNAL_OIDC_FULL_LOGOUT_URI": getOrDefault(c.Raw, "EXTERNAL_OIDC_FULL_LOGOUT_URI", ""),
	}
}
